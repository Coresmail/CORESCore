...
In order to support loading of multiple wallets in cores-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cores.cpp.
...
Changes to cores.cpp
----------------------
cores.cpp is the entry point into cores-qt, and as such, will require some minor modifications to provide hooks for
