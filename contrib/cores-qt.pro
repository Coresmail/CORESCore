...
RESOURCES += src/qt/cores.qrc src/qt/cores_locale.qrc

TRANSLATIONS += src/qt/locale/cores_bg.ts \
                src/qt/locale/cores_de.ts \
                src/qt/locale/cores_en.ts \
                src/qt/locale/cores_es.ts \
                src/qt/locale/cores_fi.ts \
                src/qt/locale/cores_fr.ts \
                src/qt/locale/cores_it.ts \
                src/qt/locale/cores_ja.ts \
                src/qt/locale/cores_pl.ts \
                src/qt/locale/cores_pt.ts \
                src/qt/locale/cores_ru.ts \
                src/qt/locale/cores_sk.ts \
                src/qt/locale/cores_sv.ts \
                src/qt/locale/cores_vi.ts \
                src/qt/locale/cores_zh_CN.ts \
                src/qt/locale/cores_zh_TW.ts
