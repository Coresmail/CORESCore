Contributing to cores Core
============================

The cores Core project operates an open contributor model where anyone is
...
The following applies to code changes to the cores Core project, and is not to be
confused with overall cores Network Protocol consensus changes.

Whether a pull request is merged into cores Core rests with the project merge
...
Patches that change cores consensus rules are considerably more involved than
...
Where a patch set proposes to change the cores consensus, it must have been
...
The project leader is the release manager for each cores Core release.
