/* src/config/cores-config.h.  Generated from cores-config.h.in by configure.  */
/* src/config/cores-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef cores_CONFIG_H

#define cores_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cores.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "cores Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "cores Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cores"
