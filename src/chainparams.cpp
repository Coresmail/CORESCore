...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000e54b60fd8ca83a62a3845998245d95881a3a1b408d4c30aa5bc7020571a"))
    (20, uint256("0x000002b7234d7739c6216bac3f39aa6a2a18546e9dab3e56ac7bc0ebf0117f7b"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1536884789, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 36550;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 cores starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1536873791 + 10000; // 14 - apr - 2018
        ...
        nStartMasternodePayments = 1536873791 + 10000; //Wed, 25 Jun 2014 20:36:16 GMT
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // cores: 1 day
        nTargetSpacing = 1 * 60;  // cores: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet cores addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet cores script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cores BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cores BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cores BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1536904106; //Fri, 09 Jan 2015 21:05:58 GMT
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // cores: 1 day
        nTargetSpacing = 1 * 60;        // cores: 1 minutes
