...
/** Utility functions used by the cores Qt UI.
 */
namespace GUIUtil
{
...
// Render cores addresses in monospace font
...
// Parse "cores:" URI into recipient object, return true on successful parsing
