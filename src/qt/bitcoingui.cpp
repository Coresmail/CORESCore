                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("cores Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a cores address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cores: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zcors"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About cores Core"), this);
    aboutAction->setStatusTip(tr("Show information about cores Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for cores"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your cores addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified cores addresses"));
    ...
    openAction->setStatusTip(tr("Open a cores: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the cores Core help message to get a list with possible cores command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("cores Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to cores network", "", count));
}
...
{
    QString strTitle = tr("cores Core"); // default title
...
/** Creates context menu, its actions, and coress up all the relevant signals for mouse events. */
