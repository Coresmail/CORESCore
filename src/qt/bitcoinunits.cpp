...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(cores);
    unitlist.append(mcors);
    unitlist.append(ucors);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case mcors:
            return QString("Milli-cores (1 / 1" THIN_SP_UTF8 "000)");
        case ucors:
            return QString("Micro-cores (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case cores:
            return QString("Testcorss");
        case mcors:
            return QString("Milli-Testcors (1 / 1" THIN_SP_UTF8 "000)");
        case ucors:
            return QString("Micro-Testcors (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
