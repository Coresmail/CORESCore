...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* cores features */
        {"cores", "masternode", &masternode, true, true, false},
        {"cores", "listmasternodes", &listmasternodes, true, true, false},
        {"cores", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cores", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cores", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cores", "masternodedebug", &masternodedebug, true, true, false},
        {"cores", "startmasternode", &startmasternode, true, true, false},
        {"cores", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cores", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cores", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cores", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cores", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cores", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cores", "mnbudget", &mnbudget, true, true, false},
        {"cores", "preparebudget", &preparebudget, true, true, false},
        {"cores", "submitbudget", &submitbudget, true, true, false},
        {"cores", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cores", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cores", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cores", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cores", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cores", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cores", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cores", "checkbudgets", &checkbudgets, true, true, false},
        {"cores", "mnsync", &mnsync, true, true, false},
        {"cores", "spork", &spork, true, true, false},
        {"cores", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cores", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use coresd, or the -server option to cores-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cores-cli " + methodname + " " + args + "\n";
}
